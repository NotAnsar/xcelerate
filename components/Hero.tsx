export default function Hero() {
	return (
		<main className='max-w-screen-main mx-auto text-center w-4/5 space-y-6 py-24 relative'>
			<div className='h-full w-auto aspect-square bg-radial absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-10' />
			<div className='text-xs px-3 py-2 border border-primary rounded-full inline-flex items-center gap-2'>
			...
			<h1 className='text-7xl font-bold  w-4/5 mx-auto text-transparent bg-text bg-clip-text'>
				Elevate Your Digital Presence with Xcelerate
			</h1>
			<p className='w-4/5 mx-auto text-xl text-gray-6 '>
